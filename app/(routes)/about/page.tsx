                ...
                <div className="border-b">
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 text-center">
                        ...
                        <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto">
                            Building the future with innovation and passion
                        </p>
                    </div>
                </div>
            </AnimationWrapper>
                ...
                <AnimationWrapper animation="fade-up" delay={0.2}>
                    <section className="mb-16 sm:mb-20">
                        ...
                        <div className="space-y-4 text-base sm:text-lg text-muted-foreground leading-relaxed">
                            <p>
                                Founded in 2020, we started with a simple mission: to create products that make a difference. What began as a small team with big dreams has grown into a passionate community dedicated to innovation and excellence.
                            </p>
                            <p>
