                            ...
                            {logo ? (
                                ...
                                <div className="w-8 h-8 rounded-lg bg-primary flex items-center justify-center">
                                    <span className="text-primary-foreground font-bold text-lg">
                                        {currentTranslation?.name.charAt(0).toUpperCase()}
                                    </span>
                                </div>
                            )}
                            <span className="font-semibold text-foreground">{currentTranslation?.name}</span>
                        </div>

                        {currentTranslation?.tagline && (
                            <p className="text-sm font-medium text-foreground">{currentTranslation.tagline}</p>
                        )}
