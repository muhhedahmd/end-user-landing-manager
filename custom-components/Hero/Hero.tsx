...
import ClientHeroVarients from "./_comp/ClientHeroVariants";
import HeroAnimation from "./_comp/HeroAnimation";
...
export default async function HeroSection({
  ...
  const companyName = companyInfo?.company?.name || "Your Company Name";
