...
type HeroResult = { status: "success" | "error"; data: PaginatedResponse<SlideShow> }
    | { status: "error" }
async function fetchSlideShows({ skip, take }: { skip: number, take: number }): Promise<HeroResult> {
    try {
